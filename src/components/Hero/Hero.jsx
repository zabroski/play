    ...
    <div className="container hero">
      <div className="hero-grid">
        ...
        <div className="hero-copy">
          ...
          <p className="text-muted">
            My name is Summer Sheridan-Zabre, a licensed clinical social worker.
            My approach to psychotherapy is to focus on relationship building
            and fun. I started my career after graduating from Syracuse
            University with a major in Social Work and a minor in Psychology...
          </p>

          <p className="text-muted" style={{ marginTop: 12 }}>
            I trained at Syracuse University and Fordham University, and bring
            decades of experience in school-based social work, play therapy, and
